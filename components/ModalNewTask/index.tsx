...
const ModalNewTask = ({isOpen, onClose, id}: Props) => {
    ...
    const inputStyles = "w-full rounded border border-gray p-2 shadow-sm dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:outline-none";
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} name="Create New Task">
            ...
            >
                ...
                <button 
                    type="submit"
                    className={`mt=4 flex w-full justify-center rounded-md border border-transparent bg-blue-primary px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-600 foucs:outline-none focus:ring-2 focus:ring-blue-600 focus-offset-2 ${
